 ...
 * @var array $_lang
 */
$_lang['locker.manager_locked_message'] = '<div class="warning">Manager actuallement verrouillé.</div>';

$_lang['setting_locker.class_name'] = 'Nom de classe';
$_lang['setting_locker.class_name_desc'] = 'Le nom de la classe de service à utiliser.';
$_lang['setting_locker.class_path'] = 'Chemin de la classe';
$_lang['setting_locker.class_path_desc'] = 'Le répertoire absolu vers la classe de service à utiliser.';
$_lang['setting_locker.flush_sessions_on_lock'] = 'Vider les sessions au verrouillage';
